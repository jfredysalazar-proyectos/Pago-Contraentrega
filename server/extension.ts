...
Reglas OBLIGATORIAS DE FORMATO HTML (CRÍTICO - NO IGNORAR):
- Responde ÚNICAMENTE con JSON válido. NO uses markdown. NO agregues texto fuera del JSON.
- web_description DEBE usar etiquetas HTML REALES: <h2>, <h3>, <p>, <ul>, <li>, <strong>.
- Los subtítulos SIEMPRE deben ser <h2> o <h3>, NUNCA texto plano. NUNCA escribas "Características Principales" como texto suelto.
- EJEMPLO CORRECTO de subtítulo: <h2>Características Principales</h2>
- EJEMPLO INCORRECTO (PROHIBIDO): Características Principales (sin etiqueta)
- MÍNIMO 600 palabras en web_description.
...

{
  ...
  "web_description": "<h2>Descripción del [NOMBRE PRODUCTO]</h2><p>[Párrafo introductorio de 4-5 oraciones con palabras clave del producto, beneficios principales y mención de Colombia. Incluye el nombre del producto varias veces de forma natural.]</p><p>[Segundo párrafo explicando casos de uso, para quién es ideal, qué problema resuelve.]</p><p>[Tercer párrafo sobre calidad, materiales o tecnología del producto.]</p><h2>Características Principales</h2><ul><li><strong>[Característica 1]:</strong> [Descripción detallada]</li><li><strong>[Característica 2]:</strong> [Descripción detallada]</li><li><strong>[Característica 3]:</strong> [Descripción detallada]</li><li><strong>[Característica 4]:</strong> [Descripción detallada]</li><li><strong>[Característica 5]:</strong> [Descripción detallada]</li><li><strong>[Característica 6]:</strong> [Descripción detallada]</li></ul><h2>¿Por qué comprar en Pago Contra Entrega?</h2><p>[Párrafo sobre la ventaja del pago contra entrega en Colombia: seguridad, confianza, sin tarjeta de crédito, paga cuando recibes.]</p><h2>¿Para Quién es Ideal Este Producto?</h2><p>[Párrafo describiendo el perfil del comprador ideal y situaciones de uso en Colombia.]</p><h2>Envío y Forma de Pago</h2><p>Realizamos envíos a todo Colombia: Bogotá, Medellín, Cali, Barranquilla, Cartagena y todas las ciudades y municipios del país. El producto llega en <strong>3 a 7 días hábiles</strong> directamente a la puerta de tu casa. <strong>Pagas únicamente cuando recibes tu pedido</strong>, en efectivo al mensajero. Sin tarjeta de crédito, sin pagos anticipados, sin riesgos.</p><h2>Preguntas Frecuentes</h2><p><strong>¿Cuánto tarda el envío?</strong> Entre 3 y 7 días hábiles a cualquier ciudad de Colombia.</p><p><strong>¿Cómo pago?</strong> Pagas en efectivo al mensajero cuando recibas tu pedido en la puerta de tu casa.</p><p><strong>¿El producto tiene garantía?</strong> Sí, todos nuestros productos tienen garantía de satisfacción.</p><p><strong>¿Puedo devolver el producto?</strong> Si el producto llega defectuoso o no es lo que pediste, gestionamos el cambio o devolución.</p><p><strong>¿Hacen envíos a municipios pequeños?</strong> Sí, llegamos a más de 1.000 municipios en todo Colombia.</p><p><em>Compra ahora con total confianza. 🛡️ Garantía incluida. Pago seguro contra entrega.</em></p>",
